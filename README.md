...
The Development experience is designed to be as simple and easy as possible. There's tools to preview what your site will look like in real-time, extensive documentation to guide you, and complete freedom under the MIT license to remove any watermarks, branding, or anything else you don’t need on your site.
